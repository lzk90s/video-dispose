...
#include "algo/vendor/gosun_ext/server/img_service_impl.h"

//----------------server params----------------
DEFINE_bool(echo_attachment, true, "Echo attachment as well");
DEFINE_int32(port, 7100, "TCP Port of this server");
DEFINE_int32(idle_timeout_s, -1, "Connection will be closed if there is no "
             "read/write operations during the last `idle_timeout_s'");

//----------------algo params----------------
DEFINE_string(base_dir, "/opt/GsFaceLib", "the base dir");
...
DEFINE_int32(img_thr_num, 3, "the number of image thread");
...
int main(int argc, char* argv[]) {
    ...
    // load algorithm
    video::algo::gosun_ext::AlgoLoader algo;
    ...
    video::algo::gosun_ext::ImgProcServiceImpl imgProcServiceImpl(algo);
